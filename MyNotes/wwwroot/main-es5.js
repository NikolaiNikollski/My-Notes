(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAuthorizationAppAuthorizationTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function AppAuthorization_form_8_div_14_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppAuthorization_form_8_div_15_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 17);
        ...
        _createClass(AppAuthorization, [{
          ...
          value: function register(form) {
            ...
            this.httpService.register(form).subscribe(function (response) {
              return _this.onCopmplete(response);
            }, function (err) {
        ...
        _createClass(AppNotelist, [{
          ...
          value: function loadNotes() {
            ...
            this.httpService.loadNotes().subscribe(function (data) {
              _this3.notelist = data.notes;

              _this3.onChangedUserName.emit(data.name);
            });
          }
        }, {
          key: "ngOnInit",
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      _context2.prev = 2;
                      _context2.next = 5;
                      return this.http.post("http://localhost/api/token/refresh", credentials, {
                    ...
                    case 16:
                      return _context2.abrupt("return", isRefreshSuccess);
